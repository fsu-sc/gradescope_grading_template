...
@hide_errors('')
def test_structure_question2_b_B_False(run_compute):
    function_name = test_structure_question2_b_B_False
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question2', 'i', **kwargs)
    if '(b) B' not in correct_answer:
        explanation = "Key: '(b) B' not found in instructor answer!\n"
        test_structure_question2_b_B_False.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question3_Agree_ques_string(run_compute):
    function_name = test_structure_question3_Agree_ques_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    ...
    if 'Agree?' not in correct_answer:
        ...
        test_structure_question3_Agree_ques_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question3_Explain_explain_string(run_compute):
    function_name = test_structure_question3_Explain_explain_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question3', 'i', **kwargs)
    if 'Explain' not in correct_answer:
        explanation = "Key: 'Explain' not found in instructor answer!\n"
        test_structure_question3_Explain_explain_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question5_a_string(run_compute):
    function_name = test_structure_question5_a_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question5', 'i', **kwargs)
    if '(a)' not in correct_answer:
        explanation = "Key: '(a)' not found in instructor answer!\n"
        test_structure_question5_a_string.explanation = explanation
        assert False
    else:
        correct_answer = correct_answer['(a)']
...
@hide_errors('')
def test_structure_question5_b_string(run_compute):
    function_name = test_structure_question5_b_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question5', 'i', **kwargs)
    if '(b)' not in correct_answer:
        explanation = "Key: '(b)' not found in instructor answer!\n"
        test_structure_question5_b_string.explanation = explanation
        assert False
    else:
        correct_answer = correct_answer['(b)']
    student_answer = run_compute('all_questions', 'question5', 's', **kwargs)
...
@hide_errors('')
def test_structure_question5_c_string(run_compute):
    function_name = test_structure_question5_c_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question5', 'i', **kwargs)
    if '(c)' not in correct_answer:
        explanation = "Key: '(c)' not found in instructor answer!\n"
        test_structure_question5_c_string.explanation = explanation
        assert False
    else:
        correct_answer = correct_answer['(c)']
    student_answer = run_compute('all_questions', 'question5', 's', **kwargs)
...
@hide_errors('')
def test_structure_question5_d_string(run_compute):
    function_name = test_structure_question5_d_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question5', 'i', **kwargs)
    if '(d)' not in correct_answer:
        explanation = "Key: '(d)' not found in instructor answer!\n"
        test_structure_question5_d_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question6_b_C2_better_classifier_than_C1_ques_string(run_compute):
    function_name = test_structure_question6_b_C2_better_classifier_than_C1_ques_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question6', 'i', **kwargs)
    if '(b) C2 better classifier than C1?' not in correct_answer:
        ...
        test_structure_question6_b_C2_better_classifier_than_C1_ques_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question6_b_C2_better_classifier_than_C1_ques_Explain_explain_string(run_compute):
    function_name = test_structure_question6_b_C2_better_classifier_than_C1_ques_Explain_explain_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question6', 'i', **kwargs)
    if '(b) C2 better classifier than C1? Explain' not in correct_answer:
        ...
        test_structure_question6_b_C2_better_classifier_than_C1_ques_Explain_explain_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question6_c_Which_metric_ques_string(run_compute):
    function_name = test_structure_question6_c_Which_metric_ques_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question6', 'i', **kwargs)
    if '(c) Which metric?' not in correct_answer:
        explanation = "Key: '(c) Which metric?' not found in instructor answer!\n"
        test_structure_question6_c_Which_metric_ques_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question6_c_explain_explain_string(run_compute):
    function_name = test_structure_question6_c_explain_explain_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question6', 'i', **kwargs)
    if '(c) explain' not in correct_answer:
        explanation = "Key: '(c) explain' not found in instructor answer!\n"
        test_structure_question6_c_explain_explain_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question7_i_Best_classifier_ques_string(run_compute):
    function_name = test_structure_question7_i_Best_classifier_ques_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    ...
    if '(i) Best classifier?' not in correct_answer:
        ...
        test_structure_question7_i_Best_classifier_ques_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question7_i_Best_classifier_comma_explain_explain_string(run_compute):
    function_name = test_structure_question7_i_Best_classifier_comma_explain_explain_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question7', 'i', **kwargs)
    if '(i) Best classifier, explain' not in correct_answer:
        ...
        test_structure_question7_i_Best_classifier_comma_explain_explain_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question7_ii_appropriate_metric_pair_string(run_compute):
    function_name = test_structure_question7_ii_appropriate_metric_pair_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question7', 'i', **kwargs)
    if '(ii) appropriate metric pair' not in correct_answer:
        ...
        test_structure_question7_ii_appropriate_metric_pair_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question7_ii_appropriate_metric_pair_comma_explain_explain_string(run_compute):
    function_name = test_structure_question7_ii_appropriate_metric_pair_comma_explain_explain_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question7', 'i', **kwargs)
    if '(ii) appropriate metric pair, explain' not in correct_answer:
        ...
        test_structure_question7_ii_appropriate_metric_pair_comma_explain_explain_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question7_iii_preferred_classifier_ques_string(run_compute):
    function_name = test_structure_question7_iii_preferred_classifier_ques_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question7', 'i', **kwargs)
    if '(iii) preferred classifier?' not in correct_answer:
        explanation = "Key: '(iii) preferred classifier?' not found in instructor answer!\n"
        test_structure_question7_iii_preferred_classifier_ques_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question7_iii_best_classifier_comma_explain_explain_string(run_compute):
    function_name = test_structure_question7_iii_best_classifier_comma_explain_explain_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question7', 'i', **kwargs)
    if '(iii) best classifier, explain' not in correct_answer:
        ...
        test_structure_question7_iii_best_classifier_comma_explain_explain_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question8_C1_better_than_random_ques_string(run_compute):
    function_name = test_structure_question8_C1_better_than_random_ques_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question8', 'i', **kwargs)
    if 'C1 better than random?' not in correct_answer:
        explanation = "Key: 'C1 better than random?' not found in instructor answer!\n"
        test_structure_question8_C1_better_than_random_ques_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question9_i_metrics_dict_lbrack_string_comma_float_rbrack(run_compute):
    function_name = test_structure_question9_i_metrics_dict_lbrack_string_comma_float_rbrack
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    ...
    if '(i) metrics' not in correct_answer:
        ...
        test_structure_question9_i_metrics_dict_lbrack_string_comma_float_rbrack.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question9_i_best_metric_ques_string(run_compute):
    function_name = test_structure_question9_i_best_metric_ques_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question9', 'i', **kwargs)
    if '(i) best metric?' not in correct_answer:
        explanation = "Key: '(i) best metric?' not found in instructor answer!\n"
        test_structure_question9_i_best_metric_ques_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question9_i_worst_metric_ques_string(run_compute):
    function_name = test_structure_question9_i_worst_metric_ques_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question9', 'i', **kwargs)
    if '(i) worst metric?' not in correct_answer:
        explanation = "Key: '(i) worst metric?' not found in instructor answer!\n"
        test_structure_question9_i_worst_metric_ques_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question9_ii_Explain_your_choices_of_best_and_worst_metrics_explain_string(run_compute):
    function_name = test_structure_question9_ii_Explain_your_choices_of_best_and_worst_metrics_explain_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question9', 'i', **kwargs)
    if '(ii) Explain your choices of best and worst metrics' not in correct_answer:
        ...
        test_structure_question9_ii_Explain_your_choices_of_best_and_worst_metrics_explain_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question10_a_better_test_based_on_F_minus_measure_ques_string(run_compute):
    function_name = test_structure_question10_a_better_test_based_on_F_minus_measure_ques_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    ...
    if '(a) better test based on F-measure?' not in correct_answer:
        ...
        test_structure_question10_a_better_test_based_on_F_minus_measure_ques_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question10_b_better_test_based_on_TPR_slash_FPR_ques_string(run_compute):
    function_name = test_structure_question10_b_better_test_based_on_TPR_slash_FPR_ques_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question10', 'i', **kwargs)
    if '(b) better test based on TPR/FPR?' not in correct_answer:
        ...
        test_structure_question10_b_better_test_based_on_TPR_slash_FPR_ques_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question10_c_Which_evaluation_measure_to_use_between_the_two_tests_ques_string(run_compute):
    function_name = test_structure_question10_c_Which_evaluation_measure_to_use_between_the_two_tests_ques_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question10', 'i', **kwargs)
    if '(c) Which evaluation measure to use between the two tests?' not in correct_answer:
        ...
        test_structure_question10_c_Which_evaluation_measure_to_use_between_the_two_tests_ques_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question10_c_Which_evaluation_measure_ques_Explain_explain_string(run_compute):
    function_name = test_structure_question10_c_Which_evaluation_measure_ques_Explain_explain_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question10', 'i', **kwargs)
    if '(c) Which evaluation measure? Explain' not in correct_answer:
        ...
        test_structure_question10_c_Which_evaluation_measure_ques_Explain_explain_string.explanation = explanation
        assert False
    else:
...
@hide_errors('')
def test_structure_question10_d_Example_scenario_where_you_would_reverse_choise_in_c_explain_string(run_compute):
    function_name = test_structure_question10_d_Example_scenario_where_you_would_reverse_choise_in_c_explain_string
    kwargs = {'student_directory': 'student_code_with_answers' , 'instructor_directory': 'instructor_code_with_answers'}
    correct_answer = run_compute('all_questions', 'question10', 'i', **kwargs)
    if '(d) Example scenario where you would reverse choise in (c)' not in correct_answer:
        ...
        test_structure_question10_d_Example_scenario_where_you_would_reverse_choise_in_c_explain_string.explanation = explanation
        assert False
    else:
